...
export async function closeTerm(input) {
    ...
    return {
        ...
        message: `Closed ${session} ${term}: archived ${result.scoresArchived} results, removed ${result.scoresDeleted} live scores${clearEnrollments ? ` and ${result.enrollmentsDeleted} enrollments` : ""}. Students, teachers, classes, subjects, and teacher assignments were kept.`,
    };
}
