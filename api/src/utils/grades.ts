// Purpose: Pure grade calculation — server is the only place that computes total/grade/remark.
...
export function calculateGrade(assessment: number, exam: number): GradeResult {
